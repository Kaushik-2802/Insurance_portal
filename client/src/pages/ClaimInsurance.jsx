...
export default function ClaimForm() {
  ...
  // Dynamic Reasons: Detects if Travel or Vehicle based on Policy prefix
  const getReasons = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.alert('Claim submitted successfully. Our team will contact you shortly.');
    navigate('/dashboard');
  };
      ...
      <div className="claim-main-content">
        ...
        <div className="claim-glass-card">
          <div className="claim-header-box">
            ...
            <p className="claim-subtitle">Enter policy details starting with <strong>TRV</strong> for Travel or <strong>VEH</strong> for Motor.</p>
          </div>

          <form onSubmit={handleSubmit} className="claim-form-layout">
            
            {/* Top Row: Policy, Mobile, Date */}
